...
metadata.putRegion(new MarsRegion("Last Reversal RF", "slice", 10390, 10410, "#42A5F5", 0.2))
metadata.putRegion(new MarsRegion("Last Reversal FF", "slice", 10490, 10510, "#FFCA28", 0.2))
